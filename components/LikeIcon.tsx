...
const LikeIcon = ({
	...
	return (
		<div className={styles.msgLikes}>
			...
			<svg
				onClick={handleMsgLikeClick}
				className={`${isAuthor ? styles.isAuthor : null} ${styles.msgLikeIcon} ${
					likedByUser ? styles.likedByUser : msgLikes > 0 ? styles.likedByOther : null
				}`}
				viewBox='0 -20 188 190'
				fill='none'
