...
const HomePageSample = () => {
    ...
    return (
        <div style={{ opacity: opacity }} onLoad={() => setOpacity(1)} className={styles.container}>
            ...
            <div className={styles.right}>
                <div className={styles.chunkOne}>
                    ...
                    <Image alt='Mute Icon' src={muteBtn} />
                    <OptionsDots />
                </div>
                <div className={styles.chunkTwo}>
                    <h4 className={styles.groupTitle}>The Psalms</h4>
                    <p className={styles.groupDescription}>A group for those with questions about specific Psalms, and for those who would like to simply share their thoughts on a particular Psalm</p>
                </div>
            ...
            <div className={styles.middle}>
                <div className={styles.message}>
                    <div className={styles.author}>
                        <div className={styles.imgContainer}>
                            <Image quality={10} fill alt='Profile photo sample' src={face1} />
                        </div>
                ...
                <div className={styles.message}>
                    <div className={styles.author}>
                        <div className={styles.imgContainer}>
                            <Image quality={10} fill alt='Profile photo sample' src={face2} />
                        </div>
                        <h6 className={styles.name}>Bob Miller</h6>
                    </div>
                    <h6 className={`${styles.content} ${styles.other} ${styles.secondMsg}`}>
                        Hey John! David is referring to the gates of Jerusalem in that verse. He is basically calling on the city to welcome the "King of glory" in a poetic way. <br /><br />
                        It is thought that this verse may be connected to the time when David brought the ark of the covenant (which represented God's presence) back from Obed-edom: 
                        <span> 2 Samuel 6:1-6:23</span>
                        <svg className={styles.likeImg} width="188" height="163" viewBox="0 0 188 163" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M49.1635 0.77892L49.1881 0.312816L49.1635 0.778922C62.1645 1.46549 75.4268 7.14916 85.9173 17.6689L85.9178 17.6694L93.5436 25.2952L93.8975 25.6491L94.251 25.2948L101.862 17.6692C122.869 -3.36748 154.897 -5.02212 173.695 13.8046C192.493 32.6323 190.867 64.7201 169.86 85.7566L162.264 93.3526L162.264 93.3528L93.8971 161.793L25.5158 93.3527L25.5157 93.3526L17.9195 85.7564C17.9195 85.7564 17.9195 85.7564 17.9194 85.7563C-3.08746 64.7347 -4.71388 32.6324 14.0847 13.8046C23.4886 4.38611 36.1784 0.0924208 49.1635 0.77892Z" fill="#E42525" stroke="rgb(69, 33, 23)" strokeWidth={0}/>
                        </svg>
                    </h6>
                ...
                <div className={styles.message}>
                    ...
                    <h6 className={`${styles.content} ${styles.user} ${styles.thirdMsg}`}>
                        ...
                        <svg className={styles.likeImg} width="188" height="163" viewBox="0 0 188 163" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M49.1635 0.77892L49.1881 0.312816L49.1635 0.778922C62.1645 1.46549 75.4268 7.14916 85.9173 17.6689L85.9178 17.6694L93.5436 25.2952L93.8975 25.6491L94.251 25.2948L101.862 17.6692C122.869 -3.36748 154.897 -5.02212 173.695 13.8046C192.493 32.6323 190.867 64.7201 169.86 85.7566L162.264 93.3526L162.264 93.3528L93.8971 161.793L25.5158 93.3527L25.5157 93.3526L17.9195 85.7564C17.9195 85.7564 17.9195 85.7564 17.9194 85.7563C-3.08746 64.7347 -4.71388 32.6324 14.0847 13.8046C23.4886 4.38611 36.1784 0.0924208 49.1635 0.77892Z" fill="rgb(69, 33, 23)" stroke="rgb(69, 33, 23)" strokeWidth={0}/>
                        </svg>
                    </h6>
