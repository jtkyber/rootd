        ...
        <div className={styles.container}>
            <form onSubmit={handleSubmit}>
                ...
                <div className={styles.genderAndVersion}>
                    ...
                    <select disabled={isLoading} id="bVersion" name='bVersion' defaultValue='Bible Version' required>
                ...
                <Link className={styles.logRegSwitch} href='/signin' replace>Already have an account?</Link>
            </form>
        </div>
    )
}
